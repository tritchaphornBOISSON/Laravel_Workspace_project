...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
	...
	<div id="navbarCollapse" class="collapse navbar-collapse justify-content-start">
		<div class="navbar-nav">
			...
			<a href="#" class="nav-item nav-link"> <i class="fa fa-users" aria-hidden="true"></i> About us</a>			
		...
		<div class="navbar-nav ml-auto action-buttons">
			<div class="nav-item dropdown">
				<a href="new-login"  class="nav-link dropdown-toggle mr-4"> <i class="fa fa-sign-in" aria-hidden="true"></i> Login</a>
               
			</div>
			<div class="nav-item dropdown">
				<a href="new-register"  class="nav-link dropdown-toggle mr-4"> <i class="fa fa-user-plus" aria-hidden="true"></i> Sign up</a>
            ...
            <div class="container"style="margin-top:-100px;">
                <div class="signin-content">
                    <div class="signin-image">
                        <figure><img src="{{asset('costumAuth/images/signin-image.jpg')}}" alt="sing up image"></figure>
        ...
        @endif
                        ...
                        @csrf
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" name="password" required autocomplete="current-password" id="password" placeholder="Password"/>
                            </div>
                            
                            <div class="form-group">
                            @if (Route::has('password.request'))
                    <a class="underline text-sm text-gray-600 hover:text-gray-900" href="new-forget">
                        {{ __('Forgot your password?') }}
                          ...
                          @endif
                            ...
                            <div class="form-group form-button">
                                <button type="submit" name="login" id="signin" class="form-submit" >{{ __('Login') }}</button>
                            </div>
                        </form>
