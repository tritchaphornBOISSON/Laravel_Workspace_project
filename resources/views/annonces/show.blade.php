...
<div align="right" style="margin-top:20px;">
	<a href="{{ route('dashboard') }}" class="btn btn-primary btn-sm"> <i class="fa fa-plus" aria-hidden="true"></i> Back</a>
...
<div class="" style="float:right;   width:40%; height:100%;">
    <div >
        <div class="col-md-15">
            <div class="card">
                <div class="card-body">
                    ...
                    <strong>Comment by: {{ $comment->user->name }}</strong>
                        ...
                        {{--Delete Comment--}}
                                <form action="{{ route('comment.destroy', $comment->id) }}" method="post" >
                                   ...
                                   <button  type="submit" style="border:none; margin-left:5px;"> <i class="fa fa-trash " aria-hidden="true"></i></button>
                    ...
                    <form method="post" action="{{ route('comment.add') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="hidden" name="annonces_id" value="{{ $data->id }}" />
                        </div>
                        <div class="form-group">
