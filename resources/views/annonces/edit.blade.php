...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <form action="{{ route('annonces.index') }}" method="GET" >
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control mr-2" name="term" placeholder="Search projects" id="term" style="margin-bottom:5px;">
                        <a href="{{ route('annonces.index') }}" class=" mt-1" ></span> 
						<span class="input-group-btn mr-5 mt-1" style=" float:right; ">
                                <button class="btn " type="button" title="Refresh page" style="float:right;">
                                    <span class="fas fa-sync-alt" style="font-size:10px; padding-right:50px;"> <i class="fa fa-refresh" aria-hidden="true"></i> Refresh</span>
                                </button>
                            </span>
                            <span class="input-group-btn mr-5 mt-1"  style="float:right; margin-left:1050px;"  > 
                            <button class="btn " type="submit" title="Search projects"  >
                            <span class="fas fa-sync-alt" style="font-size:10px; padding-left:9px;"> <i class="fa fa-search" aria-hidden="true"></i> Search</span>
                            </button>
                        </span>
		...
		<div class="navbar-nav">
			<a href="{{ route('annonces.index') }}" class="nav-item nav-link" style="margin-left:80px;"> <i class="fa fa-arrow-circle-left" aria-hidden="true"></i> Back</a>
...
<h5 class="card-header  white-text text-center py-5" style="background-color:#10DDC2">
    <strong style="color:white">Edit Ads</strong>
  </h5>
  <br>
<form method="post" action="{{ route('annonces.update', $data->id) }}" enctype="multipart/form-data">
 
 @csrf
 @method('PATCH')
 <div class="form-group">
 <label class="col-md-4 text-right" style="margin-top:15px;">Enter title</label>
 <div class="col-md-6">
 ...
 <div class="form-group">
 <label class="col-md-4 text-right" style="margin-top:15px;">Enter category</label>
 <div class="col-md-6">
 ...
 <div class="form-group">
 <label class="col-md-4 text-right" style="margin-top:15px;">Enter desciption</label>
 <div class="col-md-6">
 ...
 <div class="form-group">
 <label class="col-md-4 text-right" style="margin-top:15px;">Enter price</label>
 <div class="col-md-6">
 ...
 <div class="form-group">
 <label class="col-md-4 text-right" style="margin-top:15px;">Enter location</label>
 <div class="col-md-6">
 ...
 <div class="form-group">
 <label class="col-md-4 text-right" style="margin-top:15px;">Select Profile Image</label>
 <div class="col-md-6">
 <input type="file" name="picture" />
 <img src="{{ URL::to('/') }}/images/{{ $data->picture }}" class="img-thumbnail" width="100" />
 <input type="hidden" name="hidden_picture" value="{{ $data->picture }}" />
 </div>
 </div>
 
 <div class="form-group text-center">
 <button type="submit" name="edit" class="btn btn-danger"  style="float:right; margin-right:120px; padding-left:20px; padding-right:20pw;" value="Edit" > Edit</button>
 <br><br>
		<br><br>
 </div>
</form>
...
<telephone:06 class="06 75 48 11 44" style="float:left; color:white;"> <i  style="color:white;"class="fa fa-phone" aria-hidden="true"></i> Telephone: 06.75.48.11.44</telephone:06>
<email:Workspace@gmail class="com" style="float:right; color:white;"> <i style="color:white;" class="fa fa-envelope-o" aria-hidden="true"></i> Email: Workspace@gmail.com</email:Workspace@gmail>
<br> 
...
<br>
  Adresse: 15rue du proffesseur Charles Appleton. Lyon 69003
  </span>
</footer>
