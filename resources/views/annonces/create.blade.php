...
<h5 class="card-header  white-text text-center py-5" style="background-color:#10DDC2">
    <strong style="color:white">Add Ads</strong>
  </h5>
  <br>
<form method="post" action="{{ route('annonces.store') }}" enctype="multipart/form-data" >
	...
	<div class="form-group">
		<label class="col-md-4 text-right" style="margin-top:15px;">Enter Description</label>
		<div class="col-md-6">
	...
	<div class="form-group">
		<label class="col-md-4 text-right" style="margin-top:15px;">Enter Surface</label>
		<div class="col-md-6">
			<input type="text" name="surface" class="form-control input-lg" />
		</div>
	</div>

	
	<div class="form-group">
		<label class="col-md-4 text-right" style="margin-top:15px;">Select  Image</label>
		<div class="col-md-6">
	...
	<button type="submit"  name="add" class="btn btn-danger" value="Add" style="float:right; margin-top:-30px; margin-right:120px; padding-left:20px; padding-right:20pw;"> + Add</button>
		<br><br>
		<br><br>
