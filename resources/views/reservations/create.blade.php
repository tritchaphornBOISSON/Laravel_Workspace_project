...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <form action="{{ route('annonces.index') }}" method="GET" >
		...
		<div class="navbar-nav">
			<a href="{{ route('reservations.index') }}" class="nav-item nav-link" style="margin-left:0px;"> <i class="fa fa-arrow-circle-left" aria-hidden="true"></i> Back</a>
...
<div class="row">
    <div class="col-md-8 col-md-offset-2">
        <div class="panel panel-default">
            ...
            <div class="panel-heading" style="background-color:#10DDC2; color:white;" >
            
              <center style="padding-top:50px;" >  ADD RESERVATION   </center>
            ...
            <div class="panel-body">
                ...
                <h1> FORM </h1>
            <form    action="{{route('reservations.store')}}" method="post" class="require-validation"
...
id="payment-form">
                ...
                {{ csrf_field() }}
                <label for=""> Select your workspace </label>
                <input type="text" class="form-control" name="title"/><br /><br />
                <label for=""> Enter the first day of the reservation</label>
                <input type="date" class="form-control" name="date_debut" class="date" placeholder="Enter the 1st day"/><br /><br />
                <label for=""> Enter your last day in our locals</label>
                <input type="date" class="form-control" name="date_fin" class="date" placeholder="enter the last day"/><br /><br />
                <input type="checkbox" value="{{$_GET['id']}}" name="id"> Confirm <br /><br />

                <img class="img-responsive pull-right" src="{{asset('costumAuth/images/carte.png')}}" style="width:50%;">
                <input type="checkbox" value="{{$_GET['price']}}" name="price"> {{$_GET['price']}} montant a payer <br /><br />
...
<div class='col-xs-12 col-md-4 form-group cvc required'>
    ...
    <label class='control-label'>CID</label> <input autocomplete='off'
...
<div class="col-xs-12">
    ...
    <input class="btn btn-danger" type="submit" value="validate" style="float:right;" > </input>
