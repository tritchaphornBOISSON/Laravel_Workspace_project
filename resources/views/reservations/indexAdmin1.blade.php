...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <form action="{{ route('reservations.indexAdmin1') }}" method="GET" >
		...
		<div class="navbar-nav">
			<a href="admin" class="nav-item nav-link" style="margin-left:80px;"> <i class="fa fa-arrow-circle-left" aria-hidden="true"></i> Back</a>
