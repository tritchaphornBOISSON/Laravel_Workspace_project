...
<div class="row">
    <div class="col-lf-12 margin-tb">
        <div class="pull-left">
            <h2> All your reservation </h2>
        </div>
    </div>
</div>
  ...
  @if($res->iduser==Auth::user()->id)
    ...
    <tr>
        <td colspan = 3>
            ...
            <form action="{{ route('reservations.destroy',$res->idreservation) }}" method="POST">
             <a class="btn btn-info" href="{{ route('reservations.show',$res->idreservation) }}" style="float:right">Show</a>
                <a class="btn btn-primary" href="{{ route('reservations.edit',$res->idreservation) }} " style="float:right">Edit</a>
                @method('DELETE')
                @csrf
