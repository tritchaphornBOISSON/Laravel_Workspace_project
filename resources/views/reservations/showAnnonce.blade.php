...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
 ...
 {{ Auth::user()->name }}</div>
  ...
  <li>
	...
	<span class="b">  <img src="{{ URL::to('/') }}/images/{{ $image->picture }}" class="card-img-top" alt="Broken"  >
    <button  class="btn" onclick="window.location.href = '{{ route('reservations.create',['id'=>$image->id,'price'=>$image->price] )}}' ">Reserver</button> 
    <button  class="btn" onclick="window.location.href = '{{ route('annonces.show1', $image->id)}}' ">Show</button> </span>
